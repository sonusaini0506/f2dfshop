...
import 'package:mcsofttech/ui/module/news_and_video/widget/video_widget.dart';
...
class VideoScreen extends AppPageWithAppBar {
  ...
  void setAtScroll() {
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        controller.callSearchVideoApi(
            pageNo: controller.pageCount, size: 10, type: "Video");
      }
    });
  }
